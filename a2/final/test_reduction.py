...
if __name__ == "__main__":
	...
	if args.feature_reduction:
		print args.clf_name,args.feature_reduction
		data.append((None,X_train,X_test))
		for k in args.k:
			if args.v:
				print "Training selector"
				print "Reducing features for train data"
				print "X_train shape:",X_train.shape
			selector,X_train_new = reduce_features(X_train,y_train,args.feature_reduction,k)
			if args.v:
			...
			data.append((k,X_train_new,X_test_new))
	else:
		data.append((None,X_train,X_test))

	# Get clf
	for k,X_train,X_test in data:
		print k
		if args.clf_file:
			if args.v:
